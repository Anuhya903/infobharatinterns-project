    ...
    "fruits": 
    {
        ...
        [
            ...
            },      
            {
                ...
                "options": [ "Mango", "Papaya", "Peach", "Kiwi"],
                "correct": "Kiwi",
            ...
            },
            {
                ...
                "options": ["Blueberry","Strawberry",  "Raspberry", "Peach"],
                "correct": "Strawberry",
            ...
            },
            {
                ...
                "options": [ "Banana", "Papaya","Mango", "Peach"],
                "correct": "Mango",
            ...
            },
            {
                ...
                "options": [ "Apple", "Grape", "Pear", "Pomegranate"],
                "correct": "Pomegranate",
            ...
            },
            {
                ...
                "options": ["Pineapple","Banana",  "Papaya", "Mango"],
                "correct": "Banana",
            ...
            },
            {
                ...
                "options": [ "Lime", "Lemon", "Grapefruit""Orange"],
                "correct": "Orange",
            ...
            {
                "question": "Which fruit is shaped like a star when cut crosswise?",
                "options": [ "Kiwi", "Pineapple","Starfruit", "Banana"],
                "correct": "Starfruit",
            ...
            },
            {
                ...
                "options": [ "Plum","Cherry", "Peach", "Grape"],
                "correct": "Cherry",
            ...
            },
            {
                ...
                "options": [ "Guava", "Tamarind","Amla", "Lychee"],
                "correct": "Amla",
            ...
            {
                "question": "Which fruit's name comes from the Latin word for 'seeded apple'?",
                "options": [ "Peach", "Plum","Pomegranate", "Grape"],
                "correct": "Pomegranate",
            ...
            },
            {
                ...
                "options": [ "Apple", "Orange","Tomato", "Grape"],
                "correct": "Tomato",
            ...
            },
            {
                ...
                "options": [ "Lychee", "Dragonfruit", "Guava", "Jujube"],
                "correct": "Jujube",
            ...
            },
            {
                ...
                "options": ["Guava", "Papaya", "Tamarind", "Coconut"],
                "correct": "Tamarind",
            ...
            },
            {
                ...
                "options": [ "Lychee", "Mangosteen","Rambutan", "Durian"],
                "correct": "Rambutan",
            ...
            {
                "question": "Which fruit is known for floating on water and used during Thanksgiving?",
                "options": ["Cranberry", "Apple", "Pear", "Lime"],
                "correct": "Cranberry",
                "fact": "Cranberries float because they have tiny air pockets inside!",
                "image": "cranberry.png"
            },
            {
                "question": "Which fruit is both a color and a citrus fruit?",
                "options": ["Orange", "Lemon", "Lime", "Peach"],
                "correct": "Orange",
                "fact": "The fruit 'orange' gave the color its name, not the other way around!",
                "image": "orange.png"
            },
            {
                "question": "Which small, blue fruit is packed with antioxidants?",
                "options": [ "Blackberry", "Grape","Blueberry", "Plum"],
                "correct": "Blueberry",
                "fact": "Blueberries are considered a superfood due to their high antioxidant content.",
                "image": "blueberry.png"
            },
            {
                "question": "Which fruit has a pit and is often used to make guacamole?",
                "options": ["Peach", "Avocado", "Mango", "Olive"],
                "correct": "Avocado",
                "fact": "Avocados are rich in healthy fats and have a large seed or pit.",
                "image": "avocado.png"
            },
            {
                "question": "Which fruit has varieties like Bartlett and Anjou?",
                "options": ["Apple","Pear",  "Plum", "Grape"],
                "correct": "Pear",
                "fact": "Pears come in many types and are soft and juicy when ripe.",
                "image": "pear.png"
            },
            {
                "question": "Which fruit grows on a cactus and is also called 'tuna' in Spanish?",
                "options": ["Prickly Pear", "Dragon Fruit", "Kiwi", "Passion Fruit"],
                "correct": "Prickly Pear",
                "fact": "Prickly pears are edible cactus fruits found in desert climates.",
                "image": "cactusflower.png"
            },
            {
                "question": "Which fruit has a leathery purple skin and jelly-like segments inside?",
                "options": [ "Lychee", "Rambutan","Mangosteen", "Passion Fruit"],
                "correct": "Mangosteen",
                "fact": "Mangosteen is known as the 'queen of fruits' and is sweet and tangy.",
                "image": "mangosteens.png"
            },
            {
                "question": "Which fruit is also known as 'stone fruit' due to its hard pit?",
                "options": [ "Apple", "Banana","Peach", "Grape"],
                "correct": "Peach",
                "fact": "Peaches are soft and fuzzy fruits with a large seed in the center.",
                "image": "peach.png"
            },
            {
                "question": "Which fruit is yellow when ripe and turns your hands sticky when eaten?",
                "options": [ "Banana", "Pineapple", "Durian", "Jackfruit"],
                "correct": "Jackfruit",
                "fact": "Jackfruit is the largest tree fruit and can weigh up to 80 pounds!",
                "image": "jackfruit.png"
            },
            {
                "question": "Which tropical fruit has bright pink skin and white or red flesh with black seeds?",
                "options": [ "Papaya", "Dragon Fruit","Lychee", "Rambutan"],
                "correct": "Dragon Fruit",
                "fact": "Dragon fruit grows on a cactus and looks just as cool as it tastes!",
                "image": "dragonfruit.png"
            }
        ]   
    ...
    "flowers": 
    {
        ...
        [
            ...
            },
            {
                ...
                "options": [ "Daffodil", "Rose", "Sunflower", "Tulip"],
                "correct": "Tulip",
            ...
            },
            {
                ...
                "options": [ "Daisy", "Marigold","Sunflower", "Poppy"],
                "correct": "Sunflower",
            ...
            },
            {
                ...
                "options": [ "Moonflower", "Jasmine", "Orchid", "Night-blooming Cereus"],
            ...
            },
            {
                ...
                "options": ["Rose","Jasmine",  "Lavender", "Violet"],
                "correct": "Jasmine",
            ...
            },
            {
                ...
                "options": ["Rose", "Sunflower","Marigold",  "Daisy"],
                "correct": "Marigold",
            ...
            },
            {
                ...
                "options": [ "Bluebell", "Lavender", "Cornflower", "Forget-Me-Not"],
            ...
            },
            {
                ...
                "options": [ "Rose","Orchid", "Lotus", "Tulip"],
                "correct": "Orchid",
            ...
            },
            {
                ...
                "options": [ "Tulip", "Carnation","Rose", "Daffodil"],
                "correct": "Rose",
            ...
            },
            {
                ...
                "options": [ "Tulip", "Lily","Daffodil", "Daisy"],
                "correct": "Daffodil",
            ...
            },
            {
                ...
                "options": ["Rose","Cherry Blossom", "Magnolia", "Daisy"],
            ...
            },
            {
                ...
                "options": ["Violet","Lavender", "Bluebell", "Lilac"],
                "correct": "Lavender",
            ...
            },
            {
                ...
                "options": [ "Violet", "Daisy","Veronica", "Iris"],
                "correct": "Veronica",
            ...
            },
            {
                ...
                "options": [ "Needle Flower", "Buttonbush", "Thimbleweed", "Snapdragon"],
                "correct": "Snapdragon",
            ...
            },
            {
                ...
                "options": [ "Rose", "Carnation","Daisy", "Lily"],
                "correct": "Carnation",
            ...
            },
            {
                ...
                "options": ["Lavender", "Daffodil","Crocus", "Orchid"],
                "correct": "Crocus",
            ...
            },
            {
                ...
                "options": [ "Rose","Blue Lotus", "Sunflower", "Orchid"],
                "correct": "Blue Lotus",
            ...
            },
            {
                ...
                "options": [ "Rose","Iris", "Tulip", "Sunflower"],
                "correct": "Iris",
            ...
            },
            {
                ...
                "options": [ "Violet","Bluebell", "Daisy", "Lavender"],
                "correct": "Bluebell",
            ...
            },
            {
                ...
                "options": [ "Sunflower", "Rose","Dandelion", "Tulip"],
                "correct": "Dandelion",
            ...
            },
            {
                ...
                "options": [ "Hibiscus","Plumeria", "Orchid", "Lotus"],
                "correct": "Plumeria",
            ...
            },
            {
                ...
                "options": [ "Daisy", "Rose", "Tulip", "Hyacinth",],
                "correct": "Hyacinth",
            ...
            },
            {
                ...
                "options": [ "Rafflesia", "Sunflower","Titan Arum", "Rose"],
                "correct": "Titan Arum",
            ...
            },
            {
                ...
                "options": [ "Sunflower", "Rose","Lotus", "Lavender"],
                "correct": "Lotus",
            ...
            },
            {
                ...
                "options": [ "Rose", "Daisy","Poppy", "Sunflower"],
                "correct": "Poppy",
            ...
            },
            {
                ...
                "options": [ "Lotus","Cherry Blossom", "Rose", "Orchid"],
                "correct": "Cherry Blossom",
            ...
            },
            {
                ...
                "options": [ "Sunflower", "Tulip","moonflower", "Lily"],
                "correct": "Moonflower",
            ...
            },
            {
                ...
                "options": [ "Dandelion","Sunflower", "Marigold", "Tulip"],
                "correct": "Sunflower",
            ...
            },
            {
                ...
                "options": [ "Rose", "Tulip", "Sunflower", "Orchid"],
                "correct": "Orchid",
            ...
            },
            {
                ...
                "options": [ "Rose","Lavender", "Jasmine", "Lily"],
                "correct": "Lavender",
            ...
            },
            {
                ...
                "options": ["Tulip", "Daffodil", "Rose", "Lily"],
                "correct": "Daffodil",
            ...
            },
            {
                ...
                "options": [ "Lavender", "Rose", "Tulip", "Yarrow"],
                "correct": "Yarrow",
            ...
            },
            {
                ...
                "options": [ "Rose", "Lily", "Nasturtium","Sunflower"],
                "correct": "Nasturtium",
            ...
            },
            {
                ...
                "options": [ "Daisy", "Rose", "Tulip", "Lily of the Valley"],
            ...
            },
            {
                ...
                "options": ["Sunflower", "Desert Mariposa Lily", "Orchid", "Daisy"],
            ...
            },
            {
                ...
                "options": [ "Rose", "Lily", "Daffodil","Sunflower"],
                "correct": "Daffodil",
            ...
            },
            {
                ...
                "options": ["Tulip", "Rose","Bleeding Heart",  "Daisy"],
            ...
            },
            {
                ...
                "options": ["Rose","Marigold",  "Daisy", "Tulip"],
                "correct": "Marigold",
            ...
            },
            {
                ...
                "options": ["Tulip","Daffodil",  "Rose", "Daisy"],
                "correct": "Daffodil",
            ...
            },
            {
                ...
                "options": [ "Daisy", "Cerastium","Sunflower", "Rose"],
                "correct": "Cerastium",
            ...
            },
            {
                ...
                "options": ["Rose", "Lily","Trumpet Flower",  "Sunflower"],
            ...
            },
            {
                ...
                "options": [ "Rose","Cactus Flower", "Tulip", "Daisy"],
            ...
            },
            {
                ...
                "options": ["Sunflower", "Orchid", "Daisy""Red Rose"],
                "correct": "Red Rose",
            ...
            },
            {
                ...
                "options": [ "Sunflower", "Rose", "Daisy","Morning Glory"],
